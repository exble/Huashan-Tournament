...
public class HealthBar extends Actor
{
     ...
     */
    private int barWidth = 150; // the width of the color portion of the bar
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    private float fontSize = 20.0f; // the size of the text
    ...
    public HealthBar(String refText, String unitType, int initValue, int maxValue, int barW, int barH)
    {
        referenceText = refText;
        unitOfMeasure = unitType;
        maximumValue = maxValue;
